...
import spacy
import random
import torch.utils.tensorboard import SummaryWriter #to print tensorboard
...
class Decoder(nn.Module):
    ...
    def forward(self, x, hidden, cell):
        ...
        #shape of predictions: (1, N, length_of_vocab) -> we want to remove 1 -> (N, length_of_vocab)
